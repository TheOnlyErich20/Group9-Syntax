...
function handleLoginSubmit(e) {
    ...
    if (registeredAccounts[email] && registeredAccounts[email].password === password) {
        // Successful login
        const userData = registeredAccounts[email];
...
function handleSignupSubmit(e) {
    ...
    // Validation
    if (!fullName || !studentId || !email || !course || !password || !confirmPassword) {
    ...
    // Save account
    registeredAccounts[email] = userData;
